...
dados dizem respeito\footnote{O~primeiro comissário de dados na
  ...
  alemã: \versal{SIMITIS}, S. \emph{Kommentar zum \versal{BDSG}}. Baden"-Baden: Nomos,
...
(1973)\footnote{Lei de Dados sueca, datada de 11 de maio de 1973. Essa
  ...
  consulte"-se Simitis, C. et al. (Ed.). \emph{Data Protection in the
...
mas como\footnote{Ver Simitis. \emph{Kommentar}, p. 57; cf. Westin, A.
...
razões\footnote{Jennifer Valentino"-Devries, ``\emph{What They Know About You}'' (O~Que
...
Integridade Da Vida Social}, \footnote{Helen Nissenbaum,
...
esclarecedoras\footnote{Fred Cate, ``\emph{The Failure of Fair Information Practice
...
fazê"-lo\footnote{Ian Kerr, ``\emph{The Legal Relationship Between Online Service
...
quando leem não as compreendem\footnote{Joseph Turow, Lauren Feldman
e Kimberly Meltzer, ``\emph{Open to Exploitation: American Shoppers}
...
realisticamente, não as conseguiriam ler mesmo se quisessem\footnote{Lorrie
Faith Cranor e Joel Reidenberg, ``Can User Agents Accurately
...
``consentimento informado''\footnote{Solon Barocas e Helen Nissenbaum,
...
restrições respeitadas\footnote{Barocas e Nissenbaum, ``\emph{On
Notice}'' (Aviso) e Toubiana, Nunes, Boneh, Nissenbaum e Barocas,
``\emph{Adnostic}''.}.
...
carregam significados importantes\footnote{Vincent Toubiana e Helen
Nissenbaum, ``An Analysis of Google Log
...
mas sim a nossa fé no sistema\footnote{Deborah Franklin, \emph{``Uninformed
...
milhões em todo o mundo\footnote{Ver Katie Hafner e Matthew Lyon,
...
informação e do comércio\footnote{John Perry Barlow,
...
pelos próprios usuários\footnote{Clay Shirky, \emph{Here Comes
...
emocionantes\footnote{Samantha Shapiro, ``Revolution, Facebook"-Style'' (Revolução ao estilo
...
\emph{\textless{}https://bit.ly/2LWy64y\textgreater{}}; Adam Barth, Anupam Datta,
John Mitchell e Helen Nissenbaum, ``Privacy
...
contextos\footnote{Nissenbaum, \emph{Privacy in Context} (Privacidade no contexto),
...
para algumas necessidades de aplicação de lei\footnote{David Kocieniewski,
...
que autorizam ou proíbem a publicação\footnote{\emph{Internal Revenue Service}
...
advogado\footnote{\emph{Hearings on Revenue Revision} (Audiências sobre Revisão de
...
excelência\footnote{Elizabeth Anderson, \emph{Value in Ethics and
...
padrões internos de excelência\footnote{Milton Friedman, ``Can
...
e também transparente na esfera acadêmica\footnote{Sergey Brin and Lawrence Page, ``\emph{The Anatomy of a Large"-Scale
...
Veja também Alex Diaz, ``\emph{Through the Google Goggles:
...
online\footnote{Robert Ellis Smith, ``\emph{Ben Franklin's Web Site: Privacy and
...
interno\footnote{Lucas Introna e Helen Nissenbaum, ``Shaping the Web: Why the Politics
...
rejeitar anúncios de publicidade comportamental\footnote{47. Toubiana e
Nissenbaum, ``An Analysis of Google Log Retention
...
sociais\footnote{Nissenbaum, \emph{Privacy in Context} (Privacidade no contexto),
...
liberdade\footnote{Danielle Citron, ``\emph{Fulfilling Government 2.0's Promise with
