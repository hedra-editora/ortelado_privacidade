...
Bull\footnote{Ver, por exemplo, \versal{BULL}. \emph{Datenschutz als
...
mas como\footnote{Ver \versal{SIMITIS}. \emph{Kommentar}, p. 57; cf. \versal{WESTIN}.
...
popularizou o termo ``autodeterminação informacional''\footnote{\versal{SIMITIS}.
  Reviewing Privacy in an Information Society. \emph{University of
  Pennsylvania Law Review}, 135, 1987, p. 734; \versal{SIMITIS}\emph{. Die
  informationelle Selbstbestimmung, Grundbedingung einer
  verfassungskonformen Informationsordnung}, \versal{NJW}, 1984, p. 398ff;
  \versal{VOGELSANG}. \emph{Grundrecht auf informationelle Selbstbestimmung}.
...
detrimento das liberdades negativas\footnote{Para a Alemanha, ver
  \versal{KRIELE}; \versal{FREIHEIT}; \versal{GLEICHHEIT}. \emph{Handbuch des Verfassungsrechts}.
  In: \versal{BENDA} et al. (Ed.). 1984; para os \versal{EUA}, ver \versal{KARST}. Equal
  Citizenship Under The Fourteenth Amendment. \emph{Harvard Law Review},
  91, 1977, p. 1; \versal{KARST}. \emph{Belonging to America}. 1989. Sobre o
  renascimento cívico republicano em geral, ver \versal{MICHELMAN}. Law's
  Republic. \emph{Yale Law Journal}, 97, 1988, p. 1493; \versal{POWELL}. Reviving
  Republicanism. \emph{Yale Law Journal}, 97, 1988, p. 1703; \versal{SANDEL}.
  \emph{Liberalism and the Limits of Justice}. 1982; \versal{POCOCK}. \emph{The
...
britânica 62 de proteção de dados\footnote{O~Ato britânico de Proteção
  ...
  \versal{KUITENBROUWER}; \versal{PIPE}. Compendium of European Data Protection
  Legislation. In: \emph{Data Protection in the European Community},
  \versal{SIMITIS} et al (Ed.).}. As leis de proteção de dados suíça e alemã,
...
forma imparcial das leis\footnote{Ver \versal{BURKERT}. Institutions of data
...
online''\footnote{Este ensaio beneficiou"-se das oportunidades de apresentação no
...
\addcontentsline{toc}{chapter}{\large\versal{A FANTASIA DO OLHAR TOTAL}, \scriptsize{\emph{por Silvia Viana}}}
\begin{flushright}
\emph{Silvia Viana}
\end{flushright}
