...
\addcontentsline{toc}{chapter}{\large\versal{PREFÁCIO}\medskip}
...
a \emph{web} sofreu uma gradual, porém profunda, mudança nesses anos. O~insight
...
as denúncias do empregado terceirizado que prestava serviços à \versal{NSA} de
que a agência de segurança estadunidense vigia bilhões de pessoas no
...
Brasil, onde inclusive a presidente teve suas comunicações
...
segurança da informação, como as CryptoRaves, organizadas por ativistas
e acadêmicos, proliferaram e têm atraído um público maior a cada ano.

Este livro pretende oferecer um primeiro contato com esses temas complexos
...
Julgamos que esta coletânea possa vir a ser útil em cursos de graduação
e pós"-graduação.
...
de vigilância em massa foi possível graças à hegemonização do modelo de
...
desenvolvimento de outra tecnologia: a máquina fotográfica. Para os
...
mental''. Assim, a dupla argumenta que o Direito Comum nos \versal{EUA} deveria se
...
europeus formularam leis específicas sobre o tema. Viktor
...
relação à anterior para melhor se adaptar ao desenvolvimento tecnológico
...
ambiente distribuído dos minicomputadores --, para uma legislação focada
...
Helen Nissembaum é uma das principais críticas do paradigma regulatório
...
deveria ser diferente nesse meio. Grande parte dos serviços na \emph{web} são
análogos a serviços \emph{offline} e portanto, segundo a autora, devem seguir a
...
contextual à noção de ``contexto'' como apresentada na lei de
privacidade endossada por Obama em 2012.

Vigilância é um tema correlato ao da privacidade e da proteção de dados
pessoais. Foucault descreve como no século \versal{XVIII} a vigilância aos poucos
...
descrição da sociedade disciplinar é adequada para os séculos \versal{XVIII} e
\versal{XIX}, mas depois da segunda guerra esse modelo começou a ser
...
proliferação dos circuitos fechados de \versal{TV} (\versal{CCTV}) e na crescente gama de
dispositivos de localização. Os alvos da vigilância são classificados em
um processo denominado pelo autor de ``triagem social''. Essa triagem é cada
vez mais ubíqua e móvel e cada vez mais mediada por códigos que ``congelam''
retóricas, discursos políticos e preconceitos.

O~livro termina com um ensaio escrito por Silvia Viana para uma
...
informações \emph{a posteriori} ou influenciando ideologicamente os fluxos de
...
verdade obedecem ambos ao imperativo da produção. Silvia argumenta que
...
\addcontentsline{toc}{chapter}{\large\versal{QUATRO REFLEXÕES SOBRE A PRIVACIDADE
E A VIGILÂNCIA}\medskip}

\section{A~pirataria e o movimento de cultura livre foram corresponsáveis
...
gratuitos e participativos, de nascentes páginas \emph{web} a listas de e"-mail
...
acostumadas nos meios de comunicação de massa, como a \versal{TV} e as revistas
semanais.
...
ou para que clicassem em hiperlinks como se vira uma página de
revista ou se troca de canal de \versal{TV}. O~modelo que tinham em mente para
financiar esses portais de produção centralizada era o da venda de
assinaturas, como faziam os jornais, as revistas e a \versal{TV} a cabo. Esse
...
Usenet. Alguns desses experimentos como a Wikipédia ou a rede Indymedia
...
se abrindo ao público mais amplo. Próximo dele, havia também o movimento
...
organizada colocaram"-se como competidores extramercantis que tornaram
...
qualquer tipo de produto ou serviço na internet\footnote{Sobre
  a competição entre produtos mercantis e extramercantis: Carlotto, M.
  ...
  Sociais}, v. 26, n. 76, 2011. pp. 77-102.}. Como Chris Anderson havia
...
modelo baseado na exploração da publicidade, como já fazia a \versal{TV} aberta, e
...
2.0\footnote{O`Reilly, T. What Is Web 2.0. 2005.
  Disponível em
  \emph{\textless{}https://oreil.ly/2jOvae7\textgreater{}}.}.
...
pudesse-se recolher muitas informações pessoais dos usuários.
...
meio de mecanismos internacionais como os tratados da \versal{OMPI} e os
Relatórios Especiais 301\footnote{Para um balanço
  histórico rico e detalhado da formação destes instrumentos
  internacionais, veja: Sell, S. \emph{Private Power, Public Law: The
  Globalization of Intellectual Property Rights.} Cambridge: Cambridge
  University Press, 2003 e também Drahos, P. \emph{Information
...
conteúdos privados que a \versal{NSA} montou seu monstruoso sistema de vigilância
...
usuários\footnote{Dantas, M. ``Mais-valia 2.0:
  produção e apropriação de valor nas redes do capital''
  \emph{\textless{}https://bit.ly/2MuiJRR\textgreater{}} (\emph{Eptic
    online: revista electrônica internacional de economia política da
  informação, da comunição e da cultura}), \versal{ISSN}"-e 1518-2487,
  \emph{\textless{}https://bit.ly/2tiOSmL\textgreater{}}, {{Vol. 16, Nº 2,
  2014}}, pp. 85-108.}.
...
compradores para seus produtos\footnote{Smythe, D.
  W. ``On the audience commodity and its work''. \emph{Media and cultural
  studies: Keyworks} (1981): pp. 230-56.}.
...
pela empresa\footnote{Caraway, B. ``Audience labor
  in the new media environment: A~Marxian revisiting of the audience
  commodity''. \emph{Media, Culture \& Society} 33.5 (2011): pp. 693-708.}.
...
dos usuários\footnote{Beverungen, A., Böhm, S.
  e Land, C. ``Free labour, social media, management: Challenging
      Marxist organization studies''. (2015): pp. 473-489.}.
...
subjetividade possível, apenas alienação. Se nos ativermos, porém, com
mais cuidado ao problema, veremos que no fundo não são as nossas
interações que são mercantilizadas. %, mas nossa atenção. 
As empresas que controlam as plataformas de comunicação estão interessadas
apenas muito indiretamente no conteúdo do que produzimos ao nos
comunicarmos por meio dessas ferramentas. Por isso o pouco controle
sobre nossa atividade. Por outro lado, há uma acirrada disputa sobre
nossa atenção, especialmente durante nosso tempo de lazer.
...
como as fotos de um primo distante recém nascido ou um comentário
sensível de um amigo de infância --, aquilo que se busca vender -- desde
...
e comum a todos os usos que explicasse ``verdadeiramente'' ou
``essencialmente'' o que é a privacidade.
...
corrente no direito e na sociologia que enfrenta questões reais sobre a
...
absolutistas da monarquia na Inglaterra do século \versal{XVII}, a privacidade
...
assim se antecipe à organização daqueles que se opõem a ele a partir da
...
entrar''\footnote{Citado em Bendich, A. M. ``Privacy,
  Poverty, and the Constitution''. \emph{California Law Review}, v. 54, n.
  2, 1966. }.
...
séculos. Assim, no século \versal{XVIII} se consolidaram os direitos civis, no
\versal{XIX}, os direitos políticos e no \versal{XX}, os direitos sociais. Essa sucessão,
...
global operado pela Agência de Segurança Nacional dos \versal{EUA}, apenas
...
80 está no centro deste debate o conceito de \emph{autodeterminação
...
particular, muitos começaram a questionar a solução amplamente adotada
...
companhias a elevarem seus padrões de segurança\footnote{Apenas
  em três meses de 2016, de abril a junho, a Open Whisper Systems
  (\emph{\textless{}https://whispersystems.org/blog/\textgreater{}}), empresa que desenvolve o
...
ponta veio com o vazamento de documentos da \versal{CIA} em março de 2017. As
informações reveladas pelo Wikileaks indicam que, diferente do modelo
exposto quatro anos antes, a forma de vigilância usada pela \versal{CIA} explora
...
\chapter*{O~direito à privacidade\footnote{Originalmente publicado na \emph{Harvard
  Law Review}, v. \versal{IV}, n. 5, dez. 1890.}}\label{o-direito-uxe0-privacidade}

\addcontentsline{toc}{chapter}{\large\versal{O DIREITO À PRIVACIDADE},
\scriptsize{\emph{por Samuel D. Warren e \\
Louis D. Brandeis}}\medskip}
...
\emph{quod servitium amisit}\footnote{Nota do tradutor: ``No ordenamento
  ...
  vítima mortal ou de lesão corporal grave enquadram"-se na ação por \emph{loss
  of consortium}, que teve como antecedente histórico a ação medieval \emph{per
  quod servitium amisit}, através da qual o senhor podia exigir uma
  indenização ao terceiro que agredisse um dos seus servos, sempre que
  de tal agressão resultasse a impossibilidade de o senhor se beneficiar da
  força de trabalho desse servo. Por analogia com essa ação
  desenvolveu"-se uma outra, a \emph{per quod consortium amisit}, que reconhecia
  ...
  primeiro se beneficiar do trabalho doméstico, das relações sexuais e/ou
  da companhia antes proporcionadas pela mesma. Esta ação passou a
  designar"-se, mais tarde, por \emph{loss of consortium}. Na Inglaterra,
  tal ação foi abolida pela seção 2 do
  Administration of Justice Act de 1982. No entanto, nos Estados
  Unidos a figura teve um grande desenvolvimento, mantendo"-se atual.
  Neste país, a partir da segunda metade do século \versal{XX}, a ação passou a
  ...
  reconhecida aos filhos do lesado (\emph{loss of parental consortium}) e aos
  membros de uniões de fato''. In: Cascarejo, G. \emph{Danos não patrimoniais dos
  familiares da vítima de lesão corporal grave: Danos reflexos ou danos
  direitos?} Tese de doutorado. Porto: Universidade do Porto, 2014.}, e ao
  se permitir a indenização por danos aos sentimentos dos pais, %maridos?
uma reparação adequada foi garantida\footnote{O
...
meios de expressão\footnote{``Sendo esta a lei, qual é o fundamento a
  ...
  Direito Comum provavelmente não tinham entre os seus muitos méritos
  ...
  da legislação moderna nesse assunto, através do \emph{stat.} 8
...
propriedade\footnote{``A~questão será se o projeto de lei constatou
  ...
  tiver sido escrita no decorrer da amizade, tanto a continuidade
  quanto a interrupção da amizade oferecem um motivo para a
  interferência da corte dos tribunais''. Lord Eldon in Gee \emph{versus}
  ...
  de não assistidos ou lesados por estatutos, dá guarida à privacidade e
  ...
  nunca podem servir como base única da jurisdição civil, a
  ...
  \emph{versus} Judd, 4 Duer, 379, 384 (1855).}%?????
...
vice"-chanceler Knight Bruce referiu"-se à publicação do que um homem
...
\emph{vs.} Wilson em 1820, a respeito de uma gravura de George \versal{III}
...
proporciona essa ampla base sobre a qual a proteção ao indivíduo pode
ser assegurada.
...
propriedade do conteúdo das cartas foi adotada\footnote{Veja"-se Sr.
  Ministro Story em Folsom \emph{versus} Marsh, 2 Story, 100, \versal{III}
  (1841):
...
Devemos, portanto, concluir que o direito, desse modo protegido,
...
ser, já encontrou expressão na lei da França\footnote{Loi Relative a la
  Presse. \versal{II} Mai I868.

  ``\versal{II}. Toute publication dans un écrit periodique relative à un fait de
...
atribuídos %?
um privilégio similar\footnote{Wason \emph{versus} Walters,
...
matéria na qual seu próprio interesse é envolvido\footnote{Essa
  ...
  tribunal de equidade, tal carta ou tais cartas como for necessário ou
...
da liberdade de expressão, ignorá"-la completamente\footnote{``Mas
  ...
  O~vice"-chanceler Knight Bruce sugeriu em Príncipe Albert
  \emph{vs.} Estranho, 2 DeGex \& Sm. 652, 694, que uma distinção
...
legislação\footnote{O~seguinte anteprojeto de lei foi preparado por
  ...
  \versal{SEÇÃO} 1. Quem quer que publique, em qualquer diário, jornal, revista
  ...
  ``\versal{SEÇÃO} 2. Não constituirá defesa para nenhuma ação criminal
...
Europa\footnote{Texto originalmente publicado em
  \versal{AGRE}, P. E., \versal{ROTENBERG}, M. (org). \emph{Technology and Privacy: The
  NewLandscape.} Cambridge, \versal{MA}:The \versal{MIT} Press, 1997, pp. 219-242.}}\label{o-desenvolvimento-geracional-da-proteuxe7uxe3o-de-dados-na-europa}

\addcontentsline{toc}{chapter}{\large\versal{O~DESENVOLVIMENTO GERACIONAL DA PROTEÇÃO DE DADOS NA EUROPA}, \scriptsize{\emph{por Viktor Mayer"-Schönberger}}\medskip}
...
tautológica\footnote{\versal{SASSE}, C. \emph{Sinn und Unsinn des
...
dados dizem respeito\footnote{O~primeiro comissário de dados na
  ...
  alemã: Simitis, S. \emph{Kommentar zum \versal{BDSG}}. Baden"-Baden: Nomos,
...
terminologia, apesar de reconhecer que este termo está lidando com o que é e
...
parte dos países europeus desde 1970\footnote{O~estado alemão de Hesse
  ...
  \emph{Bundesdatenschutzgesetz} (\versal{BDSG}), em 1977. Em 1978, França,
...
ele deve ser encarado\footnote{Ver, por exemplo, Flaherty, D.
...
relativamente pequena quantidade de trabalhos internacionais provém da \versal{OECD}
...
de dados pessoais{]}\footnote{\versal{OCDE}. \emph{Guidelines on the Protection
...
próprio texto, das diretrizes da \versal{OECD}\footnote{As orientações e as suas
...
legislarem suas próprias leis de proteção de dados\footnote{Diretriz
  95/46/\versal{EG} relativa à proteção das pessoas em relação ao tratamento de
  dados pessoais e à livre circulação de tal dados, \versal{OJ}, 23 nov. 1995, L~281/31.}.
...
França\footnote{Milberg, S.; Burke, S.;
Smith, H. J.; Kallman, E. \emph{Values, Privacy,
  Personal Information and Regulatory Approaches}. Communications of the
  \versal{ACM} 58, n. 12, 1995, p. 65-74.}. Se diferenças significativas foram
mesmo detectadas, elas tinham mais a ver com aspectos singulares de
privacidade e proteção de dados dentro do próprio país do que com
...
importante demonstração de Colin Bennett\footnote{Bennett, C.
...
Se de fato for o caso das leis de proteção de dados estarem se
...
pessoais em gigantescos bancos de dados nacionais\footnote{Bennett, C.
  \emph{Regulating Privacy}, p. 45-53.}.

A~Lei de Proteção de Dados do estado alemão de Hesse (1970)\footnote{Hessisches
  Datenschutzgesetz vom 7.10.1970, \versal{GVB}l, 1970 I, p. 625.}, a sueca
(1973)\footnote{Lei de Dados sueca, datada de 11 de maio de 1973. Essa
  ...
  consulte"-se Simitis, S. et al. (Ed.). \emph{Data Protection in the
...
Rheinland"-Pfalz (1974)\footnote{Lei contra o Uso Indevido de Dados de
  24 de janeiro de 1974, \versal{GVB}l. 31.}, várias propostas para uma Lei
Federal de Proteção de Dados alemã\footnote{Proposta de uma Lei para Proteger
  Dados Pessoais contra Uso Indevido Durante o Processamento de Dados,
  21 de setembro de 1973, \versal{BT}"-\versal{DRS} 7/1027; compare"-se a proposta de
  ...
  parecer sobre a proposta pela Steinmüller, W. et al. \emph{Grundfragen des
  Datenschutzes}. \versal{BT}"-\versal{DRS} 6/3826, p. 5.}, as propostas austríacas
(1974)\footnote{Proposta do Governo de uma Lei Federal para Proteger os
  Dados Pessoais, nº 1423 d. Sten.Prot. 13. \versal{GP} \versal{NR}.} e, finalmente, a
promulgada Lei Federal de Proteção de Dados alemã (1977)\footnote{O~nome
  ...
  o processamento de dados''. A~\versal{BDSG} foi promulgada em 27 de janeiro de
  1977. Ver \versal{BGB}l. I, 1978, p. 201.} podem ser vistas como reações
...
Sem a computação, a feição moderna do Estado de bem"-estar social não
...
informações em um único banco nacional de informações\footnote{Bennett, C.
  \emph{Regulating Privacy}, p. 47; Flaherty, D. \emph{Privacy and
  Government Data Banks}, p. 105.}.

Planos semelhantes existiram na Alemanha. O~estado da Baviera queria
usar os computadores instalados para os Jogos Olímpicos em 1972 para
formar um sistema centralizado de informações\footnote{Steinmüller, W.
...
abrangente\footnote{Walter, H. et al. \emph{Informationssysteme in
...
proteção dos dados pessoais\footnote{Steinmüller, W. \emph{Grundfragen}.
  In: Stadler et al. \emph{Datenschutz}. 1975; Simitis, S.
  \emph{Kommentar}, p. 51. Ver também 1º parágrafo 2 \versal{BDSG}, proposta do
...
mundo, encarna essa abordagem funcional\footnote{Hessisches
  Datenschutzgesetz, de 7 de outubro de 1970, \versal{GVB}l. I, p. 625.}. Ela
...
organizacionais para o processamento de dados\footnote{Podlech, A.
...
cada um dos bancos de dados estruturados\footnote{§9 der \versal{RV} zum \versal{DSG}, Nr.
  1423 d. Beilagen zu den Sten.Prot. des \versal{NR} 13. \versal{GP}.}.
...
Alemanha\footnote{§17, \versal{BDSG}.}, e o (mais proeminente) Conselho Suíço de
...
normas de proteção de dados estabeleceram o direito do Poder Legislativo de
...
executiva\footnote{Por exemplo, parágrafo 6º, Hessisches
  ...
  Datenschutzgesetz, 1974; art. \versal{III} da proposta de uma Lei
  Constitucional de Proteção de Dados austríaca, 11 jun. 1974, Nr. \versal{II} --
  3586 der Beilagen zu den Sten. Protocolo do \versal{NR} 13. \versal{GP}.}.
...
regulação\footnote{§ 6 e § 2 da proposta austríaca e §1 da \versal{BDSG}.}. E
exigia"-se que ``bancos de dados'' fossem registrados\footnote{O~§39 da
  \versal{BDSG} afirma o dever de registrar. Funções de registo similares podem
  ser encontradas na proposta austríaca de 1974 e no § 10 da proposta
  alternativa de Podlech. A~esse respeito o Ato de Proteção de
  Dados britânico de 1984 é um tanto anacrônico, uma vez que seus procedimentos de
  ...
  parágrafo da Lei de Dados sueca.}.
...
simples controle do seu acesso físico\footnote{Por exemplo, o parágrafo
  6º e o parágrafo 2º da Lei de Dados sueca, parágrafos 1º, 2º e 5º do
  apêndice até o § 6/1/1 da \versal{BDSG}, §9 (1) do Ato de Registro das
  Autoridades Públicas Dinamarquesas, §9/2 da proposta austríaca e §45
  da proposta do Podlech.}. De acordo com esse cenário, mesmo a exigência da
...
sensato\footnote{Consulte a \emph{Datenschutzbeauftragter}, o alemão
  \versal{BDSG} de 1977 e as propostas para a Lei de Proteção de Dados austríaca.}.
...
procedimentos rigorosos baseados no estado da arte tecnológica, deu lugar
...
sugeriu"-se a reforma das leis de proteção de dados\footnote{Simitis, S.
  \emph{Kommentar}, p. 48.}.
...
pessoais\footnote{Bull, H. P. \emph{Datenschutz als Informationsrecht und
  Gefahrenabwehr}, \versal{NJW} 1979, p. 1177-1182.}. A~privacidade informacional
...
Espanha e de Portugal\footnote{Artigo 35 da Constituição Portuguesa de
  ...
  austríaca (\versal{DSG}), 1978; Art. 18, parágrafo 4º. Constituição espanhola
...
Os estatutos de proteção de dados francês\footnote{Ato nº 78-17 em
  ...
  Relativa à Proteção dos Dados Pessoais (\versal{DSG}), \versal{BGB}l. 565/78.}, e em
certa medida o dinamarquês\footnote{O~estatuto dinamarquês é ainda
  ...
  o setor público, o Ato de Registro para Autoridades
  Públicas, nº 621 de 2 de outubro de 1987; e outro para o setor
  privado, o Ato para Registros Privados etc., nº 293 de 8
...
eles mesmos\footnote{Conforme estabelecido no parágrafo 4º do
  Hessisches \versal{LDSG} (1970), na seção 10 da Lei sueca de Dados (1973), nos
  §11-§14 do \versal{LDSG} Rheinland"-Pfalz (1974), no §16 da proposta de Podlech,
...
proteção de dados. Todavia, a regulação continuou a se dar a nível
...
Bull\footnote{Ver, por exemplo, Bull, H. P. \emph{Datenschutz als
  Informationsrecht und Gefahrenabwehr}. \versal{NJW} 1979, p. 1177-1182.} --
...
alguma forma os ajudasse a fazer valer os direitos previstos nas leis de
proteção de dados.
...
dinamarquesa (\versal{DSA}) também tem poder decisório sobre demandas individuais
...
Essa reorientação da proteção de dados, da regulação da tecnologia para
a sua configuração como liberdade individual, foi associada
retoricamente às velhas categorias jurídico"-legais do direito à
...
O~direito do cidadão em aderir a serviços sociais e ser beneficiário de
programas de transferência de renda governamentais exige um fluxo contínuo de
...
possam ser apenas exercidos por eremitas? Chegamos a um plano ideal de
...
pergunta não é mais se alguém quer participar desse processo social,
mas como\footnote{Ver Simitis, S. \emph{Kommentar}, p. 57; cf. Westin, A.
  \emph{Privacy and Freedom}, p. 7.}.

Esta foi a linha de argumentação da famosa decisão sobre o censo alemão
da Corte Constitucional do país\footnote{Decisão do Senado, 15 de
  dezembro de 1983, 1 \versal{B}v\versal{R} 209/83-\versal{\versal{NJW}}
  1984, p. 419.} de 1983, que
popularizou o termo ``autodeterminação informacional''\footnote{Simitis, S.
  ``Reviewing Privacy in an Information Society''. \emph{University of
  Pennsylvania Law Review}, 135, 1987, p. 734; Simitis, S\emph{. Die
  informationelle Selbstbestimmung, Grundbedingung einer
  verfassungskonformen Informationsordnung}, \versal{NJW}, 1984, p. 398ff;
  Vogelsang, K. \emph{Grundrecht auf informationelle Selbstbestimmung}.
...
detrimento das liberdades negativas\footnote{Para a Alemanha, ver
  ...
  In: Benda, E. et al. (Ed.). 1984; para os \versal{EUA}, ver Karst, K. Equal
  Citizenship Under The Fourteenth Amendment. \emph{Harvard Law Review},
  91, 1977, p. 1; Karst, K. \emph{Belonging to America}. 1989. Sobre o
  renascimento cívico republicano em geral, ver Michelman, F. Law's
  Republic. \emph{Yale Law Journal}, 97, 1988, p. 1493; Powell, H. J. Reviving
  Republicanism. \emph{Yale Law Journal}, 97, 1988, p. 1703; Sandel, M.
  \emph{Liberalism and the Limits of Justice}. 1982; Pocock, J. G. A. \emph{The
...
consequências específicas acarretadas caso ele se negue a
consentir com o processamento dos seus dados.

O~tribunal também considerou insuficiente a linguagem dos direitos de
participação existentes. Sob o regime funcional outrora mais restritivo
...
tribunal é o arquetípico das leis da terceira geração. O~indivíduo não
...
antes imaginadas, as quais já haviam sido comprovadas ineficientes
anteriormente.
...
legislações tivessem abandonado a ideia de regulamentar a tecnologia. Ao
...
Tribunal Constitucional; a tardia reforma deral %??
à Lei Federal de
Proteção de Dados alemã (1990); a reforma de 1986 da Lei de
Proteção de Dados austríaca, na qual os procedimentos de autorização e registro
...
pessoais; e, por fim, reformas pontuais da da Lei de Registro
Civil finlandesa de 1987.
...
ampliados novamente. As diversas e novas leis alemãs de proteção de
...
bancários e financeiros, se a recusa em fornecer seus dados pessoais
...
geralmente fraca. A~quarta geração de leis de proteção de dados tenta
...
privada do indivíduo constante das normas de proteção de segunda e
...
na proteção de dados pessoais\footnote{Parágrafo 7º, (nova) Lei Federal
  de Proteção de Dados alemã de 1990. Para obter um exemplo de uma regra
...
sensíveis via de regra era proibido. Esse conceito está previsto no §6º da
...
britânica 62 de proteção de dados\footnote{O~Ato de Proteção
  de Dados britânico autoriza o governo a regulamentar ainda mais a proteção de
  ...
  Kuitenbrouwer, F.; Pipe, G. ``Compendium of European Data Protection
  Legislation''. In: \emph{Data Protection in the European Community},
  Simitis, S. et al (Ed.).}. As leis de proteção de dados suíça e alemã,
...
exclusão pelo indivíduo\footnote{Ver artigo 8, seção 6, Lei de
  Proteção de Dados suíça (1992); Parágrafo 6º, Lei Federal de Proteção de
  Dados alemã (1990); parágrafo 5º, seção (1), último parágrafo, Lei de
  Proteção de Dados do estado alemão de Brandemburgo (\versal{B"-LDSG}).}. Da mesma
...
proteção de dados\footnote{§1--§5 da Lei de Registro de
  Pessoas finlandesa regulamentam o uso de arquivos para pesquisa, estatística,
...
mesmo nos países em que as leis gerais de proteção de dados têm uma longa
...
quadro geral ser complementado setorialmente\footnote{Por exemplo, a
  ...
  1994, \versal{BGB}l. 1994/194.}. E, nesse linha, as diretrizes da União
...
forma imparcial das leis\footnote{Ver Burkert, H. ``Institutions of data
...
últimos assumiam o papel decisório de deliberar acerca dessas
...
leis de proteção de dados da Finlândia (1987)\footnote{Lei finlandesa de
  Registro de Pessoas, 30 de abril de 1987, 471-\versal{HE} 49/86.} e da Suíça
...
as regras de proteção de dados. Isso produz uma simbiose
...
(\versal{ARCO}) são dela protagonistas. Lista"-se o consentimento do titular dos
...
amplia substancialmente a aplicação da proteção de dados na esfera
administrativa. Além do mais, inclui algumas regras específicas para a proteção de
dados setoriais\footnote{§14 (b), que regulamenta o
...
destacada em todos os sistemas europeus de proteção de dados. Afastou"-se de
...
europeias sobre a proteção de dados para \versal{ISDN}\footnote{\emph{\versal{ISDN}:
...
\addcontentsline{toc}{chapter}{\large\versal{UMA ABORDAGEM CONTEXTUAL DA PRIVACIDADE ON-LINE}, \scriptsize{\emph{por Helen Nissenbaum}}\medskip}

\begin{flushright}
\emph{Helen Nissenbaum}
%\footnote{Helen Nissenbaum é Professora de Mídia, Cultura e Comunicações e Membro
%Sênior no Instituto de Direito de Informação na Universidade de Nova
%York. Seus livros incluem \emph{Privacy in Context: Technology, Policy
%and the Integrity of Social Life} -- Privacidade no Contexto: Tecnologia,
%Política e a Integridade da Vida Social (2010), \emph{Academy \& the
%Internet} -- Academia \& Internet (editado com Monroe E. Price, 2004) e
%\emph{Computers, Ethics \& Social Values} -- Computadores, Ética e
...
O~ano de 2010 foi marcante para a ``privacidade online''.
Relatos sobre ``gafes da privacidade'',
...
razões\footnote{Valentino"-Devries, J. \emph{What They Know About You} (O~que
eles sabem sobre você), The Wall Street Journal, 31 de julho de 2010,
\emph{\textless{}https://on.wsj.com/2HRWgux\textgreater{}}.}.
O~governo dos Estados Unidos, através da
Comissão Federal de Comércio -- \emph{Federal Trade Commission --
(\versal{FTC})}\footnote{U.S. Federal Trade Commission (Comissão Comercial Federal dos Estados
Unidos), relatório pessoal preliminar da \versal{FTC}, ``Protecting Consumer Privacy in an
...
políticas), de dezembro de 2010, \emph{\textless{}https://bit.ly/2JUy1Rn\textgreater{}}.}
e do Departamento de Comércio\footnote{U.S. Department
of Commerce (Departamento do Comércio dos \versal{EUA}),
...
2010, \emph{\textless{}https://bit.ly/2JGBlA7\textgreater{}}.}, lançou dois relatórios em dezembro de 2010,
...
opinião e ``buscadores de atenção''\footnote{Comparar essas
representações com as contas anteriores da Internet
como uma nova fronteira da liberdade e da autonomia: por exemplo,
Johnson, D. e Post, D., ``Law and Borders -- The Rise of Law in
Cyberspace'' (Leis e Limites -- O~Surgimento das Leis no Espaço
Cibernético), \emph{Stanford Law Review} 48 (1996): 1367;
Barlow, J., ``Electronic Frontier: Coming into the \emph{Country}''
(Fronteiras Eletrônicas: Chegando ao País) \emph{Communications of the
\versal{ACM}} 34 (3) (Março de 1991).}.
...
atividades e as agitações deste campo, a fim de identificar os
princípios, as forças e os valores em jogo. Considera"-se por que a
``privacidade online'' tem sido marginalizada, mas para além das
preocupações gerais sobre privacidade; por que as abordagens correntes
...
formativos da Internet como um bem público\footnote{Neste ensaio,
eu extraí a maioria dos meus exemplos da \emph{World
...
resultantes da atividade baseada na rede; e porque em experiências
...
Integridade Da Vida Social}\footnote{Nissenbaum, H.
\emph{Privacy in Context: Technology, Policy, and
...
Imprensa da Universidade de Stanford, 2010).}, apresento uma análise
...
Neste caso, nós diríamos que as normas informacionais foram violadas em
...
cookies, latências, cliques, endereços de \versal{IP}, gráficos sociais
...
discutido longamente em \emph{Privacy in Context}\footnote{Idem, capítulo 5.}.
...
``transparência e escolha'' falhou\footnote{\emph{Federal Trade
Commission} (Comissão Federal de Comércio),
...
\emph{Federal Trade Commission -- (\versal{FTC})} e do Departamento de Comércio
mencionados acima) têm chamado a atenção para processos de tomada de
decisão falhos, bem como informações pouco
esclarecedoras\footnote{Cate, F. ``The Failure of Fair Information Practice
...
informação''), ed. Jane K. Winn (London: Ashgate Publishing, 2006).}.
Uma vez que escolher significa
...
fazê"-lo\footnote{Kerr, I., ``The Legal Relationship Between Online Service
...
1--40.}. Embora possa parecer que indivíduos
...
quando leem não as compreendem\footnote{Turow J., Feldman, L.
e Meltzer, K., ``\emph{Open to Exploitation: American Shoppers}
...
Pensilvânia, 1 de junho de 2005), \emph{\textless{}https://bit.ly/2JGdErO\textgreater{}}.} e,
realisticamente, não as conseguiriam ler mesmo se quisessem\footnote{Cranor,
L. F. e Reidenberg, J., ``Can User Agents Accurately
Represent Privacy Notices?'' (Agentes de usuários podem fielmente representar avisos de
...
comunicação, informação e políticas de Internet) (\versal{TPRC}2002), Alexandria,
Virgínia, 28 a 30 de setembro de 2002.}. Isto não
é uma mera questão de falta de vontade.
...
exigiriam os princípios de informação justa\footnote{\emph{U.S. Department
of Health, Education, and Welfare} (Departamento de
Saúde, Educação e Bem"-Estar dos Estados Unidos), ``Records,
Computers, and the Rights of Citizens'' (Registros, Computadores e os
Direitos dos Cidadãos), relatório do Comitê Consultivo da Secretaria
para a automatiçazão de sistemas de dados pessoais, de julho de 1973,
\emph{\textless{}https://bit.ly/2t1OBVE\textgreater{}}.}. Os
...
``consentimento informado''\footnote{Barocas, S. e Nissenbaum, H.,
``On Notice: The Trouble with
...
outubro de 2009; Toubiana, V., Nunes, A., Boneh, D.,
Nissenbaum, H. e Barocas, S., ``Adnostic: Privacy"-Preserving Targeted
...
San Diego, Califórnia, de 28 de fevereiro a 3 de Março, 2010.}. Para começar, examine
...
recursiva cuja extensão é indefinível\footnote{Calculando os
servidores de anúncios sozinhos, uma lista atualizada a
partir de abril de 2011 mostra 2.766 entradas exclusivas; veja em:
\emph{\textless{}https://bit.ly/2JOAfyk\textgreater{}} (acessado em 13 de abril de 2011).}. Como
...
restrições respeitadas\footnote{Barocas, S. e Nissenbaum, H., ``On
Notice'' (Aviso) e Toubiana, V., Nunes, A., Boneh, D., Nissenbaum, H. e Barocas, S.,
``Adnostic''.}.
...
carregam significados importantes\footnote{Toubiana, V. e
Nissenbaum, H., ``An Analysis of Google Log
...
Privacidade e Confidencialidade) (em breve).}. Daí surge o
paradoxo da transparência: transparência do significado textual e
transparência do conflito prático em termos de absorção da
informação\footnote{Por exemplo, a informação pessoal não é compartilhada
com ninguém e é destruída após cada sessão.}. Parecemos incapazes de
alcançar um sem desistir do outro, no entanto, ambos são essenciais para
o modelo de ``consentimento informado'' funcionar.
...
mas sim a nossa fé no sistema\footnote{Franklin, D. ``Uninformed
Consent'' (Consentimento desinformado), \emph{Scientific American},
de março de 2011, 24-25.}. Confiamos nos
...
Agora, a história é familiar: com o advento da \emph{\versal{ARPANET}} e, à
...
milhões em todo o mundo\footnote{Ver Hafner, K. e Lyon, M.,
\emph{Where Wizards Stay Up Late:
The Origins of the Internet} (Quando os assistentes ficam acordados até
tarde: as origens da Internet) (Nova York: Simon e Schuster, 1999);
Berners"-Lee, T., \emph{Weaving the Web: The Past, Present and Future of the
...
Publishing, 2000); e Abbate, J., \emph{Inventing the Internet}
(Inventar a Internet) (Cambridge, Massachusetts: \versal{MIT} Press, 2000).}.
Por progredir através
destes estágios, a Internet tem sido conceitualizada por uma série de
pensadores influentes\footnote{Sobre essa transformação da Internet
através da ``luta'' das partes
interessadas, ver Clark, D., Wroclawski, J., Sollins, K. e
Braden, R., ``Tussle in Cyberspace: Defining Tomorrow's Internet'' (A~Briga
no Ciberespaço: Definindo o Amanhã da Internet) Anais da Conferência
\versal{ACMS}ig\versal{C}omm de 2002, Pittsburgh, Pensilvânia, 19 a 23 de agosto de 2002,
publicados no \emph{Computer Communications Review} (Revisão nas
Comunicações em Computadores) 32 (4) (Outubro de 2002).}: de \emph{super estradas da
informação}\footnote{Al Gore, ``Infrastructure for the Global Village: Computers, Networks
...
1991, 150-153.}, permitindo rapidez no fluxos de
informação e do comércio\footnote{Barlow, J. P.,
``A~economia das ideias'', Wired, março de 1994, 84.}; de ciberespaço, uma nova
...
pelos próprios usuários\footnote{Shirky, C., \emph{Here Comes
...
emocionantes\footnote{Shapiro, S., ``Revolution, Facebook"-Style'' (Revolução ao estilo
Facebook) \emph{The New York Times}, 22 de janeiro de 2009,
\emph{\textless{}https://nyti.ms/2tbwSdL\textgreater{}}.}.
...
\emph{Amazon}, \emph{Netflix}, \emph{Mayo Clinic}, \emph{Web\versal{MD}},
\emph{eBay} e \emph{\versal{E*TRADE}}. E, por fim, programas e serviços tais como
...
gerado pelo usuário por meio de inumeráveis blogs, \emph{wikis} e websites
pessoais e, por fim, repositórios de escala global: a
\emph{Wikipedia}, \emph{\versal{IMD}b, mmorgs} (gigantesco \emph{multiplayer}
...
comerciais\footnote{\emph{Federal Trade Commission} (Comissão de Comércio Federal), ``Protecting
Consumer Privacy in an Era of Rapid Change'' (Proteger a privacidade do
consumidor em uma Era de rápidas mudanças) e \emph{Department of Commerce}
...
da economia da Internet).}. Certamente, os contornos da tecnologia
...
resistência\footnote{Compare esta concepção a alegação de Mark Zuckerberg que as normas
mudam devido aos contornos das políticas de privacidade do Facebook; Ver
Bosker, B., ``Facebook's Zuckerberg Says Privacy No Longer a `Social
Norm'", (Zuckerberg do Facebook diz que a privacidade não é mais uma
`norma social'), The Huffington Post, 11 de janeiro de 2010,
\emph{\textless{}https://bit.ly/2JFllyC\textgreater{}}.}.
...
pelas regras de privacidade formuladas pela \versal{FTC}, quem está embuída dessa
competência pela lei \emph{Gramm"-Leach"-Bliley
Act}\footnote{\emph{U.S. Federal Trade Commission} (Comissão Federal de Comércio dos
Estados Unidos), Gramm"-Leach"-Bliley Ato 15 \versal{U.S.C.}, Subcapítulo I, secão
6801--6809, 12 de November de 1999,
\emph{\textless{}https://bit.ly/2LWy64y\textgreater{}}; Barth, A., Datta, A.,
Mitchell, J. e Nissenbaum, H., ``Privacy
...
the \versal{IEEE} Symposium on Security and Privacy} (Procedimentos do Simpósio
sobre Segurança e Privacidade) Berkeley, Califórnia, 21 de Maio de 2006.}.
Informações auxiliares (por exemplo,
endereço do \versal{IP} ou \emph{histórico de navegação}), os registros das
...
\versal{NYT}imes.com e \versal{MOMA}.org que são afetadas pelas marcas correspondentes
...
Bethlehem/Pensilvânia\footnote{A~livraria \emph{Moravian Book
Shop} tem agora o seu próprio portal
online, \emph{\textless{}http://www.moravianbookshop.com\textgreater{}}.}. Como a Amazon.com
expandiu"-se para outros campos, vendendo e alugando \versal{DVD}s, supõe"-se que
...
1988\footnote{\emph{The Video Privacy Protection} (A~Proteção da Privacidade) Ato
18 \versal{U.S.C.} artigo 2710, 1988,
\emph{\textless{}http://www.law.cornell.edu/uscode/html/uscode18/usc\_sec\_18\_00002710-\/-\/-\/-000-.html\textgreater{}}.%link não existe
} da mesma forma que a White Coast Vide está
...
\emph{MayoClinic.com} e a \emph{Web"-\versal{MD}} até portais do governo federal,
...
Vaticano\footnote{Veja: \emph{\textless{}http://www.vatican.va/phome\_en.htm\textgreater{}}.}, até igrejas
online\footnote{Veja: \emph{\textless{}http://www.online-churches.net\textgreater{}}.}.
Eles oferecem compromisso religioso online que
...
\emph{\versal{E*TRADE}}, mesmo ele operando principalmente através de um portal
...
contextos\footnote{Nissenbaum, H., \emph{Privacy in Context} (Privacidade no contexto),
especificamente o capítulo 8.}. Novas atividades e práticas, que
...
para algumas necessidades de aplicação de lei\footnote{Kocieniewski, D.,
``\versal{IRS} Sits on Data Pointing to Missing Children''
(As páginas do \versal{IRS} com dados sobre crianças desaparecidas), \emph{The
New York Times}, 12 de novembro de 2010,
\emph{\textless{}https://nyti.ms/2Mt4JHW\textgreater{}}.}.
...
que autorizam ou proíbem a publicação\footnote{Internal Revenue Service
(Serviço Interno de Impostos),
\emph{Disclosure and Privacy Law Reference Guide} (Guia de
referências sobre as leis de privacidade e divulgação) publicação 4639
(10/2007) número de catálogo 50891P, 1--7.}''. Esta
...
advogado\footnote{Hearings on Revenue Revision (Audiências sobre Revisão de
...
sessão 8--9 (1925).}''. Uma presunção de estrita
...
tais como o \emph{Mayo Clinic} e o \emph{Web\versal{MD}} podem se assemelhar ao
do ambiente familiar; sites de informação de saúde são
prodigiosos\footnote{Uma pesquisa no Google sobre ``status de
\versal{HIV}'', realizada 11 de janeiro
de 2011, produziu mais de 7,5 milhões de resultados.},
oferecendo de tudo, desde serviços personalizados
...
Federal de Comércio -- \emph{Federal Trade Commission -- (\versal{FTC})} e do
...
online\footnote{\emph{Federal Trade Commission} (Comissão Federal de Comércio),
``Protecting Consumer Privacy in an Era of Rapid Change''
(Proteger a privacidade do consumidor em uma era de rápidas mudanças); e
\emph{Department of Commerce} (Departamento De Comércio), ``Commercial Data
Privacy and Innovation in the Internet Economy''. (A~privacidade dos
dados comerciais e a inovação da economia da Internet).}. Nenhuma dessas agências reconheceu
...
\emph{Microsoft Atlas} entre outros)\footnote{Noob Cook é
apresentado como sendo escrita por ``uma garota que gosta
de cozinhar''; consulte: \emph{\textless{}http://www.noobcook.com/about/\textgreater{}}
(acessado em 25 de fevereiro de 2011).}. Vale
registrar, que o \emph{Wikipedia}, apoiado pela fundação sem fins
lucrativos \emph{Wikimedia}, não apresenta rastreadores\footnote{Estabelecer
o número de seguidores em um site é altamente inexato.
...
Comércio -- \emph{Federal Trade Commission -- (\versal{FTC})} seriam precisamente
...
excelência\footnote{Anderson, E., \emph{Value in Ethics and
Economics} (Valorização em ética e economia), (Cambridge, Mass.:
Harvard University Press, 1995), 147.}''. Nós esperamos mais deles -- de
...
padrões internos de excelência\footnote{Friedman, M., ``Can
Business Afford to be Ethical?: Profits before
Ethics''(Os negócios podem ser éticos?: Lucros antes de ética) in
...
Martin's Press, 1991), 313--318.}. Quando Sergey Brin
...
e também transparente na esfera acadêmica\footnote{Brin, S. e Page, L.
\emph{The Anatomy of a Large"-Scale
Hypertextual Web Search Engine} (A~anatomia de um mecanismo
hipertextual de busca na internet em grande escala),
\emph{\versal{WWW}7/Computer Networks} 30 (1--7) (1998): 107--117; citação
retirada da versão na rede, \emph{\textless{}https://stanford.io/1l0ULwZ\textgreater{}}
(acessado em 26 de fevereiro de 2011).

Veja também Diaz, A. ``Through the Google Goggles:
...
levantadas: por exemplo, a compra pela \emph{Amazon} do \emph{\versal{IMD}b} -- um
...
online\footnote{Smith, R., ``Ben Franklin's Web Site: Privacy and
Curiosity from Plymouth Rock to the Internet'' (Site de Ben Franklin: Privacidade e curiosidades
...
interno\footnote{Introna, L. e Nissenbaum, H., ``Shaping the Web: Why the Politics
of Search Engines Matters'' (Moldando a rede: Porque a política do mecanismo de pesquisa
importa), \emph{The Information Society} 16 (3) (2000): 1--17;
de Frank, P. e Bracha, O., ``Federal Search Commission?
...
Narayanan, Boneh, Nissenbaum e Barocas, ``\emph{Adnostic}''.}. O~mesmo argumento se aplica a
...
rejeitar anúncios de publicidade comportamental\footnote{Toubiana, L., e
Nissenbaum, H., ``An Analysis of Google Log Retention
Policies'' (Uma análise das políticas de retenção de logs do Google).}.
...
\emph{ChoicePoint}\footnote{Veja \emph{``Choicepoint}''
(Ponto de Escolha), \versal{EPIC}"-Electronic
Privacy Information Center, \emph{\textless{}http://epic.org/privacy/choicepoint/\textgreater{}}
(acessado em 13 de abril de 2011).}. Contudo, os bancos de dados de
...
relação\footnote{Como uma questão prática, padrões para contextos de comunicação serão
necessários através do design de interface. Ver, por exemplo, o trabalho
de Ryan Calo e Lorrie Cranor.}. Permanecer fiel a estes autorretratos
...
sociais\footnote{Nissenbaum, H., \emph{Privacy in Context} (Privacidade no contexto),
especialmente os capítulos 8--9.}. Nesse sentido, as restrições sobre os
...
liberdade\footnote{Citron, D., ``Fulfilling Government 2.0's Promise with
...
(4) (Junho 2010): 822--845.}. Se as pessoas esperam ser monitoradas e
...
Este ensaio beneficiou"-se das oportunidades de apresentação no
...
privacidade da \versal{NYU} (New York University), pela orientação especializada
...
subsídios \versal{AFSOR}: \versal{ONRBAA} 07 / 03 (\versal{MURI}) e
\versal{NSF} \versal{CT"-M}: Privacidade,
Conformidade \& Informação de Riscos, \versal{CNS}"-0831124.

\chapter*{Vigilância como triagem social: códigos de computador e corpos
móveis\footnote{A~presente tradução foi feita a partir de \versal{LYON}, David.
  \emph{Surveillance as Social Sorting: Privacy, Risk and Digital
  Discrimination.} London: Routledge, 2003, pp. 13-30 (nota do editor).}}

\addcontentsline{toc}{chapter}{\large\versal{VIGILÂNCIA COMO TRIAGEM SOCIAL: CÓDIGOS DE COMPUTADOR E CORPOS MÓVEIS}, \scriptsize{\emph{por David Lyon}}\medskip}
...
novas direções para os estudos sobre vigilância no início do século \versal{XXI}\footnote{Este
texto foi originalmente entregue como artigo na School of
...
inexorável). A~vigilância é sempre ambígua (\versal{LYON}, 1994, p. 219; \versal{NEWBURN};
\versal{HAYMAN}, 2002, p. 167-8). Ao mesmo tempo, a triagem social coloca
...
(\versal{TETRAD}, 2001). O~grupo U6, ``Pressão da Cidade Grande'', é um pouco
...
-- códigos \versal{ZIP} nos Estados Unidos -- as agências de publicidade
...
muitas vezes conhecidos como ``redlining'' (\versal{PERRI}, 2001, p. 6) ou
``\emph{weblining}'' (\versal{STEPANEK}, 2000), os consumidores são classificados
...
uma terapia de reposição de estrogênio (\versal{HAFNER}, 2001). Dados online e
...
para a detecção e prevenção de crimes (\versal{MARRON}, 2001). Agora, os oficiais
...
um banco de dados e um software de inteligência corporativa da \versal{IBM}.
...
muito maior nas avaliações de risco (\versal{ERICSON}; \versal{HAGGERTY}, 1997). A~maneira
...
digitalização da íris ou amostras de \versal{DNA}, são exploradas pela exatidão
...
televisão (\versal{CCTV}) ou ``vigilância por vídeo'', e o outro se refere a uma
...
Europa e Ásia estão usando os \versal{CCTV} como um meio de controlar o crime e
...
estão caindo mais rápido do que em outras cidades canadenses (\versal{TOMAS},
2000). Na maioria dos casos, bancos de dados indexados ainda não são
utilizados em conjunto com os \versal{CCTV}, embora o objetivo de criar
...
armazenadas digitalmente. Em Newham, Londres, os \versal{CCTV} são reforçados por
sistemas inteligentes capazes de reconhecimento facial (\versal{NORRIS};
\versal{ARMSTRONG}, 1999). Em um caso célebre em 2000, as catracas para os
eventos anuais do Super Bowl na Flórida foram filmadas por um sistema de
\versal{CCTV} que comparou mais de 100 mil imagens daqueles que entraram no
...
conhecidos (\versal{CNN}, 2001). A~crescente utilização de câmeras de segurança
digital pode vir a incentivar essa tendência (\versal{BLACK}, 2001). Desde 11 de
setembro de 2001, no entanto, muitas cidades manifestaram um amplo
interesse pelos sistemas \versal{CCTV} de reconhecimento facial para reduzir o
...
Sofisticados sistemas de \versal{CCTV}, como aqueles de Newham, Londres, podem
...
usam satélites de posicionamento global (no inglês, \versal{GPS}) e sistemas de
informação geográfica (\versal{SIG}), em conjunto com a telefonia sem fio,
...
emergência (\versal{ROMERO}, 2001). Isso também é previsível e o benefício para
...
rastrear a localização de quem realiza chamadas (\versal{BARNETT}, 2000).
Juntamente com os Sistemas de Transporte Inteligente (\versal{STI}), essas
...
primeiro lugar, desaparecer com ele (\versal{LYON}, 2001b).
...
no contexto de sociedades crescentemente individualizadas (\versal{BAUMAN}, 2001)
...
declarações sobre a privacidade como um bem público ou comum (ver \versal{REGAN},
...
mais líquidas (\versal{BAUMAN}, 2000), e os dados de vigilância,
correspondentemente, estão mais interconectados e devem ser vistos em
termos de fluxos (\versal{URRY}, 2000). Não é apenas \emph{onde} as pessoas estão
...
digamos, um circuito fechado de \versal{CCTV} de rua, funcione simplesmente para
...
sistemas de \versal{CCTV}, predominantemente operados por humanos --, um
...
casos (\versal{GANDY}, 1993; 1995; 1996). Ela filtra e classifica com propósitos
...
(\versal{GRAHAM}; \versal{MARVIN}, 2001), como sua área é policiada e que tipo de
...
Federal\footnote{Nota do Tradutor: nos Estados Unidos, Internal Revenue
  Service ou \versal{IRS}}, remunerações trabalhistas, benefícios por invalidez
...
domicílio é elegível para o vale"-alimentação, o almoço escolar, o \versal{ADC} e
o Medicaid\footnote{Nota do Tradutor: O~Medicaid é um programa de saúde
  ...
  necessidades especiais.}'' (\versal{GILLIOM}, 2001, p. 18). Para aqueles cujos
...
política. (\versal{BOWKER}; \versal{STAR}, 1999, p. 50)
...
vigilância dos \versal{CCTV}, mais outros tipos de categorias preconceituosas
entrarão em jogo. Na Grã"-Bretanha, ser jovem, homem e negro é garantia
de um maior índice de controle pelas câmeras de rua (\versal{NORRIS}; \versal{ARMSTRONG},
1999).
...
assim como a maioria dos sistemas de \versal{CCTV}, ainda requerem operadores
...
de política congelado'' (\versal{BOWKER}; \versal{STAR}, 1999, p. 135). Em primeiro lugar,
...
(ver também \versal{ERICSON}; \versal{BARRY}; \versal{DOYLE}, 2000). E~gestores de recursos
...
(\versal{BENIGER}, 1986). O~que é verdadeiro sobre a internet é também verdadeiro
...
(\versal{DELEUZE}, 1992). A~codificação é crucial, porque se supõe que os códigos
...
consumidores) que ainda têm de acontecer (ver também \versal{BOGARD}, 1996). Os
...
audiovisuais'' (\versal{VIRILIO}, 1994). Virilio se refere a esse tipo de
...
inglês, \emph{dataveillance}; ver \versal{CLARKE}, 1988{]} têm sido aumentados
...
é estabelecida (não apenas determinada; ver \versal{VAN DER PLOEG}, 1999) pelos
códigos.
...
íris ou de impressões digitais (\versal{WALTERS}, 2001). Após os atentados de 11
...
Obviamente, no século \versal{XXI} mais e mais pessoas querem atravessar
...
assistência médica do governo e vice"-versa (\versal{HAFNER}, 2001). Mas, em
...
(1987; ver também \versal{HAGGERTY}; \versal{ERICSON}, 2000). Essa vigilância não se
...
dos gramados suburbanos. Alguns sistemas de \versal{CCTV} parecem ``se
...
baseados na telefonia sem fio, vídeo, dados de \versal{GPS} recentemente
...
Systems ou \versal{ITS}), tais como pedágios com tecnologias automatizadas ou
dispositivos de navegação ou de monitoramento a bordo. Outros conectam
recursos de \versal{GPS} e \versal{SIG} com telefones celulares para permitir que a
...
e pós"-estruturalistas (\versal{BOYNE}, 2000), quanto a começar com as respostas
de políticas públicas mais comuns -- proteção de dados e privacidade --
e retornar às análises partindo delas (\versal{GILLIOM}, 2001, p. 8). O~relato
...
o ``\emph{switching power}'' (\versal{CASTELLS}, 1996) nas sociedades
...
social automatizada. Como defendo em outro texto (\versal{LYON}, 2001a), o rosto
...
\begin{Parskip}
\versal{BARNETT}, A. Every Move You Make\ldots{} \emph{Observer}, 2000.
Disponível em:
\emph{\textless{}http://www.guardianunlimited.co.uk/Print/0,3858,4045760,00.html.\textgreater{}}%link não existe
Acesso em: 30 jul. 2000.

\versal{BAUMAN}, Z. \emph{Liquid Modernity}. Cambridge: Polity Press, 2000.

\_\_\_\_\_\_. \emph{The Individualized Society}. Cambridge: Polity
Press, 2001.

\versal{BENIGER}, J. R. \emph{The Control Revolution}: Technological and Economic
Origins of the Information Society. Cambridge, \versal{MA}: Harvard University
Press, 1986.

\versal{BLACK}, D. Crime Fighting's New Wave, The Toronto Star. 2001. Disponível
em:
\emph{\textless{}http://www.torstar.com/thestar/editorial/tech/20000125NEWOld\_CI-UPFRONT.htm\textgreater{}}.%link não existe
Acesso em: 25 jan. 2001.

\versal{BOGARD}, W. \emph{The Simulation of Surveillance}: Hypercontrol in
Telematic Societies. New York: Cambridge University Press, 1996.

\versal{BOWKER}, J.; \versal{STAR}, L. \emph{Sorting Things Out: Classification and its
Consequences}, Cambridge, \versal{MA}: \versal{MIT} Press, 1999.

\versal{BOYNE}, R. Post"-panopticism. \emph{Economy and Society}, vol. 29, n. 2,
2000, p. 285--307.

\versal{CASTELLS}, M. \emph{The Rise of the Network Society}. Oxford: Blackwell,
1996.

\versal{CLARKE}, R. Information Technology and Dataveillance.
\emph{Communications of the \versal{ACM}}, vol. 31, n. 5, 1988, p. 498--512.

\versal{CNN}. Casinos Use Facial Recognition Technology. 2001. Disponível em:
\emph{\textless{}http://www.cnn.com/2001\versal{TECH}/ptech/02/26/casino.surveillance.ap/index.html\textgreater{}}.%link não existe
Acesso em: 26 fev. 2001.

\versal{DELEUZE}, G. Postscript on the Societies of Control. 1992. out. 59, p.
3-7.

\versal{DELEUZE}, G.; \versal{GUATTARI}, F. \emph{A~Thousand Plateaus}: Capitalism and
Schizophrenia. Minneapolis: University of Minnesota Press, 1987.

\versal{ERICSON}, R. e \versal{HAGGERTY}, K. \emph{Policing the Risk Society}. Toronto:
University of Toronto Press, 1997.

\versal{ERICSON}, R.; \versal{BARRY}, D.; \versal{DOYLE}, R. \emph{The Moral Hazards of
Neo"-liberalism}: Lessons from the Private Insurance Industry.
\emph{Economy and Society}, vol. 29, n. 4, 2000, p. 532-58.

\versal{GANDY}, O. \emph{The Panoptic Sort}: A~Political Economy of Personal
Information. \versal{CO} Boulder: Westview, 1993.

\_\_\_\_\_\_. It's Discrimination, Stupid! In: \versal{BROOK}, J.; \versal{BOAL}, A. I.
(Ed.). \emph{Resisting the Virtual Life}. San Francisco: City Lights,
1995.

\_\_\_\_\_\_. Coming to Terms with the Panoptic Sort. In: \versal{LYON}, D.;
\versal{ZUREIK}, E. (Ed.). \emph{Computers, Surveillance, and Privacy}.
Minneapolis: University of Minnesota Press, 1996.

\versal{GILLIOM}, J. \emph{Overseers of the Poor}: Surveillance, Resistance, and
the Limits of Privacy, Chicago: University of Chicago Press, 2001.

\versal{GRAHAM}, S.; \versal{MARVIN}, S. \emph{Splintering Urbanism}: Networked
Infrastructures, Technological Mobilities, and the Urban Condition.
London; New York: Routledge, 2001.

\versal{HAFNER}, K. Privacy's Guarded Prognosis. \emph{The New York Times}, New
York, 1 mar. 2001. Disponível em:
\emph{\textless{}https://nyti.ms/2HS0Itc\textgreater{}}.

\versal{HAGGERTY}, K.; \versal{ERICSON}, R. The Surveillant Assemblage. \emph{British
Journal of Sociology}, London, vol. 51, n.4, 2000, p. 605-22.

\versal{LESSIG}, L. \emph{Code and Other Laws of Cyberspace}. New York: Basic
Books, 1999.

\versal{LYON}, D. \emph{The Electronic Eye}: The Rise of Surveillance Society.
Cambridge, \versal{UK}: Polity; Malden, \versal{MA}: Blackwell, 1994.
...
\versal{LYON}, D.; \versal{ZUREIK}, E. (Ed.). \emph{Computers, Surveillance, and Privacy}.
Minneapolis: University of Minnesota Press, 1996.

\versal{MARRON}, K. New Crime Fighter Rides Along with Cops in Cruisers.
\emph{The Globe and Mail}, Toronto, 23 fev. 2001, T2.

\versal{NEWBURN}, T.; \versal{HAYMAN}, S. \emph{Policing, Surveillance, and Social
Control}: \versal{CCTV} and the Police Monitoring of Suspects. Southampton:
Willan, 2002.

\versal{NORRIS}, C.; \versal{ARMSTRONG}, G. \emph{The Maximum Surveillance Society}.
London: Berg, 1999.

\versal{PERRI} 6 \emph{Divided by Information}: The ``Digital Divide'' and
Implications of the New Meritocracy (com Ben Jupp). London: Demos, 2001.

\versal{REGAN}, P. \emph{Legislating Privacy}: Technology, Social Values and
Public Policy. Chapel Hill: University of North Carolina Press, 1995.

\versal{ROMERO}, S. Locating Devices Gain in Popularity but Raise Privacy
Concerns. \emph{The New York Times}, New York, 2001. Disponível em:
\emph{\textless{}https://nyti.ms/2HUJIlV\textgreater{}}.
Acesso em: 4 mar. 2001.

\versal{ROSEN}, J. A~Cautionary Tale for a New Age of Surveillance (Um conto
preventivo para uma nova era de vigilância). \emph{The New York Times},
New York, 7 out. 2001.

\versal{SLEVIN}, P. Cameras Caught Super bowl Crowd. \emph{Washington Post},
Washington, 2001. Disponível em:
\emph{\textless{}http://www.msnbc.com/news/524802.asp\textgreater{}}. Acesso
em: 2 fev. 2001.%link não existe

\versal{STEPANEK}, M. Weblining. \emph{BusinessWeek}, New York, 2000. Disponível
em:
\emph{\textless{}http://www.businessweek.com:/2000/00\_14/b3675027.html\textgreater{}}.
Acesso em: 3 abr. 2000. %link não existe

\versal{TETRAD}. Psyte Market Segments. 2001. Disponível em:
\emph{\textless{}http://www.tetrad.com/pcensus/com/py951st.html\textgreater{}}. %link não existe

\versal{TOMAS}, P. Ontario Today Report, July 26. 2000. Disponível em:
\emph{\textless{}http://ottawa.cbc.ca/onttoday/archives/july\_26\_00.html\textgreater{}}.
Acesso em: 7 maio 2001. %link não existe

\versal{URRY}, J. Mobile Sociology. \emph{British Journal of Sociology}, London,
vol. 51, n. 1, 2000, p. 185-203.

\versal{VAN} \versal{DER} \versal{PLOEG}, I. The Illegal Body: Eurodac and the Politics of
Biometric Identification. \emph{Ethics and Information Technology},
Dordrecht, vol. 1, n. 4, 1999, p. 295-302.

\versal{VIRILIO}, P. \emph{War and Cinema}: The Logistics of Perception. London:
Verso, 1994; \emph{The Vision Machine}. London: The British Film
Institute, 1989.

\versal{WALTERS}, J. New Immigrant \versal{ID} Cards are Proposed to Foil Illegals.
\emph{The Toronto Star}, Toronto, 2001. Disponível em:
\emph{\textless{}http://www.torontostar.ca/\versal{NAS}\ldots{}/Article\_PrintFriendly\&c=Article\&cid=99119106461\textgreater{}}. %link não existe
...
\addcontentsline{toc}{chapter}{\large\versal{A FANTASIA DO OLHAR TOTAL}, \scriptsize{\emph{por Silvia Viana}}\medskip}
\begin{flushright}
\emph{Silvia Viana}
\end{flushright}
...
evidências de tal poder: câmeras, \versal{GPS}s, aparelhos biométricos, drones,
...
das maiores corporações do ramo -- muito da lenda dos \versal{CEO}s inovadores
...
programa de \versal{TV}, por exemplo, é falsa mercadoria; seu valor não pode ser
...
\begin{Parskip}
\versal{ADORNO}, Theodor W. \emph{Mínima Moralha}. São Paulo: Ática, 1992.

\versal{AGAMBEN}, Giorgio. \emph{O~que é um dispositivo?} Disponível em:
\emph{\textless{}https://bit.ly/2tbWdV6\textgreater{}}. Última
visita: 09/05/2015

\versal{ARANTES}, Paulo. \emph{O~novo tempo do mundo.} São Paulo: Boitempo, 2014.

\versal{BENJAMIN}, Walter. \emph{O~capitalismo como religião.} São Paulo:
Boitempo, 2013.

\versal{BERNARDO}, João. \emph{Democracia totalitária: teoria e prática da
empresa soberana.} São Paulo, Cortez, 2004.

\versal{DEJOURS}, Cristophe. \emph{A~banalização da injustiça social}. Rio de
janeiro: Editora \versal{FGV}, 2000.

\versal{FUCHS}, Cristian. ``Como podemos definir vigilância?'' In: \emph{Revista
Matriz,} Ano 5 -- nº 1 jul./dez. 2011, p. 109-136. ~

\versal{MARCUSE}, Herbert. \emph{A~ideologia da Sociedade Industrial: O~homem
unidimensional}. Rio de Janeiro: Zahar Editores, 1982.

\versal{VIANA}, Silvia. \emph{Rituais de sofrimento}. São Paulo: Boitempo, ~2012.
\end{Parskip}

\section{RESUMOS DO LAVITS RIO 2015 CONSULTADOS}

\begin{Parskip}
\versal{ABDO}, Alexandre Hannud. ``Descentralização e criptografia no combate à
vigilância e controle''.

\versal{ABIUSO}, Federico Luis. ``De la vigilancia jerárquica a la vigilancia
informática: puentes y vinculaciones entre el neoliberalismo penal y las
tecnologías de control''.

\versal{ALBUQUERQUE}, Luciana Santos Guilhon; \versal{PEDRO}, Rosa Maria Leite Ribeiro.
``A~Visibilidade Por Trás Das Máscaras''.

\versal{ANDRADE}, Daniel Pereira. ``Vigilância e controle dos afetos no trabalho:
a questão do capital emocional''. ~

\versal{ANGELINI}, Alessandro. ``The Urban Nervous System: Involuntary Action and
Political Anxiety in a `Smarter' Rio de Janeiro''.

\versal{CÓRDOVA}, Yasodara; \versal{GONZALEZ}, Cristiana. ``O~poder troca de mãos: como a
Web pode proteger o usuário no contexto da Internet das Coisas''.

\versal{CUNHA}, Adriana Pessôa da. ``Redes, Coletivos e Tecnologias de
Monitoramento: novas dinâmicas do coletivo e novas formas de controle na
era das redes''.

\versal{ENGELKE}, Antonio\textbf{. ``}Midiativismo nas Jornadas de Junho:
Narrativa, Sujeito e Verdade''.

\versal{EVANGELISTA}, Rafael de Almeida; \versal{VIEIRA}, Miguel Said. ``A~máquina de
exploração da privacidade e suas conexões sociais''.

\versal{FIGARO} Roseli; \versal{NONATO}, Claudia; \versal{MORAES}, Laila de Albuquerque.
...
\versal{GONÇALVES}, Cristiana de Siqueira; \versal{PEDRO}, Rosa Maria Leite Ribeiro.
``Visibilidade e gestão de si: cartografando controvérsias acerca das
novas biotecnologias''.

\versal{LIMA}, Patricia; \versal{SANTOS}, Emanuella. ``Somos todos terroristas, até
provarmos o contrário. As implicações da vigilância em massa justificada
como medida de segurança na rede''.

\versal{PEDRO}, Rosa Maria Leite Ribeiro; \versal{RODRIGUES} Ana Paula da Cunha. ``Google
e Linked in: controvérsias acerca da visibilidade e vigilância na
contemporaneidade''.

\versal{ROCHA}, Otávio Gomes. ``O~ardil do mapeamento participativo e a renovação
das estratégias de controle territorial'.

\versal{SAETNAN}, Ann Rudinow. ``The Haystack Fallacy -- or Why Big Data Provides
Little Security''.

\versal{SAMPAIO}, Alice C. ``Privacidade em rede: a participação da Google e do
Facebook na transformação de um conceito''.

\versal{TELES}, Edson. ``Militarização da política e democracia de segurança''

\versal{WIVES}, Willian Washington. ``Vigilância e Monitoramento: efeitos micro e
macro'.
\end{Parskip}

\chapter*{Sobre os autores}

\addcontentsline{toc}{chapter}{\large\versal{SOBRE OS AUTORES}}

\noindent\versal{DAVID LYON}

\medskip

\noindent\versal{HELEN NISSENBAUM} é Professora de Mídia, Cultura e Comunicações e Membro
Sênior no Instituto de Direito de Informação na Universidade de Nova
York. Seus livros incluem \emph{Privacy in Context: Technology, Policy
and the Integrity of Social Life} (Privacidade no Contexto: Tecnologia,
Política e a Integridade da Vida Social), de 2010, \emph{Academy \& the
Internet} (Academia \& Internet), editado com Monroe E. Price, em 2004, e
\emph{Computers, Ethics \& Social Values} (Computadores, Ética e
Valores Sociais), editado com Deborah G. Johnson, em 1995.

\medskip

\noindent\versal{LOUIS DEMBITZ BRANDEIS} foi um advogado e um Associado de Justiça da
Suprema Corte dos Estados Unidos. Formado na Universidade de Harvard, com o que se
supõe ser a maior nota ponderada da história do curso de Direito, se estabeleceu em Boston,
onde se notabilizou na defesa de causas progressistas. Na Suprema Corte, afamou-se pelas
grandes defesas da liberdade de expressão e do direito à privacidade, este último um conceito
elaborado pelo próprio Brandeis em parceria com Samuel D. Warren.

\medskip

\noindent\versal{SAMUEL DENNIS WARREN} formou-se em Harvard na mesma turma que seu amigo
Louis Brandeis, com quem fundaria o famoso escritório de advocacia Nutter McClennen \& Fish.
Editor da revista \emph{Harvard Crimson}, notabilizou-se sobretudo pelo artigo ``O direito à
privacidade'', que escreveu em parceria com Brandeis. Warren largaria o Direito em 1899
para dedicar-se aos negócios da família, onde desavenças com os irmãos levariam ao seu
suicídio, em 1910.

\medskip

\noindent\versal{SILVIA VIANA}

\medskip

\noindent\versal{VIKTOR MAYER-SCHÖNBERGER}, professor de Governança e Regulação da Internet
na Universidade de Oxford, é um dos intelectuais mais importantes atuando na área da informação
na Web. Publicou, além de mais de cem artigos, \emph{Delete: The Virtue of Forgetting in the
Digital Age} (Delete: a virtude de esquecer na era virtual), que ganhou em 2010 o Prêmio Marshall
McLuhan de Livro Excepcional.