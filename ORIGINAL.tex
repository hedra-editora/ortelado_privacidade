...
relativamente pequena quantidade de trabalhos internacionais provêm da \versal{OECD}
...
impacto prático nas discussões\footnote{\versal{CONSELHO DA EUROPA}. Convenção
...
legislarem suas próprias leis de proteção de dados\footnote{Diretriz
  ...
  dados pessoais e à livre circulação de tal dados, \versal{OJ}, 23 nov. 1995, L
  281/31.}.
...
França\footnote{\versal{MILBERG}; \versal{BURKE};
\versal{SMITH}; \versal{KALLMAN}. \emph{Values, Privacy,
...
importante demonstração de Colin Bennett\footnote{\versal{BENNETT}.
...
pessoais em gigantescos bancos de dados nacionais\footnote{\versal{BENNETT}.
...
(1973)\footnote{Lei de Dados sueca, datada de 11 de maio de 1973. Essa
  ...
  consulte"-se \versal{SIMITIS} et al. (Ed.). \emph{Data Protection in the
...
Rheinland"-Pfalz (1974)\footnote{Lei contra o Uso Indevido de Dados de
  24 de janeiro de 1974, \versal{GVB}l. 31.}, várias propostas para uma Lei alemã
Federal de Proteção de Dados\footnote{Proposta de uma Lei para Proteger
  ...
  parecer sobre a proposta pela \versal{STEINMÜLLER} et al. \emph{Grundfragen des
...
informações em um único banco nacional de informações\footnote{\versal{BENNETT}.
  \emph{Regulating Privacy}, p. 47; \versal{FLAHERTY}. \emph{Privacy and
...
formar um sistema centralizado de informações\footnote{\versal{STEINMÜLLER}.
...
administração estatal\footnote{Hessische Zentrale für
  ...
  Datenverarbeitung. In: \versal{HESSEN}. \emph{Grosser Hessenplan} (Grande plano
...
abrangente\footnote{\versal{WALTER} et al. \emph{Informationssysteme in
...
proteção dos dados pessoais\footnote{\versal{STEINMÜLLER}. \emph{Grundfragen}.
  In: \versal{STADLER} et al. \emph{Datenschutz}. 1975; \versal{SIMITIS}.
...
organizacionais para o processamento de dados\footnote{\versal{PODLECH}.
...
cada um dos banco de dados estruturados\footnote{§9 der \versal{RV} zum \versal{DSG}, Nr.
...
executiva\footnote{Por exemplo, parágrafo 6º, Hessisches
  ...
  Constitucional austríaca de Proteção de Dados, 11 jun. 1974, Nr. \versal{II} --
...
sugeriu"-se a reforma das leis de proteção de dados\footnote{\versal{SIMITIS}.
  \emph{Kommentar}, p. 48.}.
...
pessoais\footnote{\versal{BULL}. \emph{Datenschutz als Informationsrecht und
