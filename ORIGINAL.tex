...
\addcontentsline{toc}{chapter}{\large\versal{PREFÁCIO}}
...
\addcontentsline{toc}{chapter}{\large\versal{O~DESENVOLVIMENTO GERACIONAL DA PROTEÇÃO DE DADOS NA EUROPA}, \scriptsize{\emph{por Viktor Mayer"-Schönberger}}}
...
ele deve ser encarado\footnote{Ver, por exemplo, \versal{FLAHERTY}.
...
relativa pequena quantidade de trabalhos internacionais provêm da \versal{OECD}
...
\addcontentsline{toc}{chapter}{\large\versal{UMA ABORDAGEM CONCEITUAL DA PRIVACIDADE ON-LINE}, \scriptsize{\emph{por Helen Nissenbaum}}}
...
\addcontentsline{toc}{chapter}{\large\versal{VIGILÂNCIA COMO TRIAGEM SOCIAL: CÓDIGOS DE COMPUTADOR E CORPOS MÓVEIS}, \scriptsize{\emph{por David Lyon}}}
