...
esclarecedoras\footnote{Cate, F. ``\emph{The Failure of Fair Information Practice
...
fazê"-lo\footnote{Kerr, I., ``\emph{The Legal Relationship Between Online Service
...
exigiriam os princípios de informação justa\footnote{U.S. Department
...
\emph{``On Notice: The Trouble with
...
restrições respeitadas\footnote{Barocas, S. e Nissenbaum, H., ``\emph{On
...
mas sim a nossa fé no sistema\footnote{Franklin, D. \emph{``Uninformed
...
comerciais\footnote{Federal Trade Commission (Comissão de Comércio Federal), ``Protecting
...
Act}\footnote{U.S. Federal Trade Commission (Comissão Federal de Comércio dos
...
online\footnote{Federal Trade Commission (Comissão Federal de Comércio),
...
Veja também Diaz, A. ``\emph{Through the Google Goggles:
...
online\footnote{Smith, R., ``\emph{Ben Franklin's Web Site: Privacy and
...
de Frank, P. e Bracha, O., ``\emph{Federal Search Commission?
