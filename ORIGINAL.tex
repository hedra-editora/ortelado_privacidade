...
(\versal{FTC})}\textsuperscript{{3}} e do Departamento de Comércio,
...
Relatório pessoal preliminar da \versal{FTC}, ``Protecting Consumer Privacy in an
...
4. U.S. Department of Commerce (Departamento do Comércio dos \versal{EUA}),
...
\versal{ACMS}igComm de 2002, Pittsburgh, Pensilvânia, 19 a 23 de agosto de 2002,
...
35. David Kocieniewski, ``\versal{IRS} Sits on Data Pointing to Missing Children''
...
38. Uma pesquisa no Google sobre ``status de \versal{HIV}'', realizada 11 de janeiro
...
48. Veja \emph{``Choicepoint},'' (Ponto de Escolha) \versal{EPIC}"-Electronic
